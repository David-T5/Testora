...
class LLMCache:
    ...
    def query(self, prompt, additional_messages=[], nb_samples=1, temperature=1, no_cache=False):
        ...
        self.nb_misses += 1
        result = self.llm_module.query(prompt, additional_messages, nb_samples=nb_samples, temperature=temperature)
