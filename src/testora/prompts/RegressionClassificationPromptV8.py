...
# Used classification_prompt_version = 7 as a basis
# Contains a 6th classification question for the LLM -> LLM may state 'unsure' if it's unsure about its classification
class RegressionClassificationPromptV8:
