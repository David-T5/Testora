...
# Prompt with changed is_legal question
class RegressionClassificationPromptV12:
...
4) Does the usage example pass inputs, or does it pass any illegal (e.g., type-incorrect) inputs? Answer either "legal" or "illegal".
